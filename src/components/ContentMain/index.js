...
const Input = LoadableComponent(()=>import('../../routes/Test/input/index'))
const Select = LoadableComponent(()=>import('../../routes/Test/select/index'))
const Model = LoadableComponent(()=>import('../../routes/Test/model/index'))
const Del_model = LoadableComponent(()=>import('../../routes/Test/del_model/index'))
    ...
    return (
      <div style={{padding: 16, position: 'relative'}}>
        <Switch>
          ...
          <PrivateRoute exact path='/home/test/input' component={Input}/>
          <PrivateRoute exact path='/home/test/select' component={Select}/>
          <PrivateRoute exact path='/home/test/model' component={Model}/>
          <PrivateRoute exact path='/home/test/del_model' component={Del_model}/>

          <Redirect exact from='/' to='/home/other/springText'/>
        </Switch>
      </div>
    )
  }
